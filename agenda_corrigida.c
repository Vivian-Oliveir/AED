...
void adicionarPessoa( void **pBuffer ) {
    *pBuffer = realloc(*pBuffer, *((( int* )*pBuffer ) + 1 ) + (100 * sizeof( char )) ); 
    char *entrada = ( char* )*pBuffer + *((( int* )*pBuffer ) + 1 );

    printf( "Digite o nome: " );
    scanf( "%99[^\n]", entrada );
    getchar();
    *((( int* )*pBuffer ) + 1 ) += strlen( entrada ) + 1; //tamanhoAtual
    *pBuffer = realloc( *pBuffer, *((( int* )*pBuffer ) + 1 ));
    ...
    *pBuffer = realloc(*pBuffer, *((( int* )*pBuffer ) + 1 ) + (100 * sizeof( char )) ); 
    entrada = ( char* )*pBuffer + *((( int* )*pBuffer ) + 1 );
